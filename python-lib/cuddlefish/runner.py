...
from .prefs import DEFAULT_COMMON_PREFS
from .prefs import DEFAULT_FIREFOX_PREFS
from .prefs import DEFAULT_THUNDERBIRD_PREFS
from .prefs import DEFAULT_FENNEC_PREFS
from .prefs import DEFAULT_NO_CONNECTIONS_PREFS
from .prefs import DEFAULT_TEST_PREFS
